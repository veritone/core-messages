...
func (*MentionEmailGenerated) Descriptor() ([]byte, []int) {
	return fileDescriptor_mention_notification_00b65175ae52edce, []int{0}
}
...
func (*MentionEmailGenerated_Mention) Descriptor() ([]byte, []int) {
	return fileDescriptor_mention_notification_00b65175ae52edce, []int{0, 0}
}
...
func (*MentionEmailGenerated_PlaceHolders) Descriptor() ([]byte, []int) {
	return fileDescriptor_mention_notification_00b65175ae52edce, []int{0, 1}
}
...
func init() {
	proto.RegisterFile("events/mention_notification.proto", fileDescriptor_mention_notification_00b65175ae52edce)
}

var fileDescriptor_mention_notification_00b65175ae52edce = []byte{
