...
$root.events = (function() {
    ...
    events.Webhook = (function() {
         ...
         * @property {events.Webhook.Encoding|null} [encoding] Webhook encoding
         * @property {google.protobuf.IAny|null} [payload] Webhook payload
         */
         ...
         * @implements IWebhook
         * @constructor
         * @param {events.IWebhook=} [properties] Properties to set
         */
        ...
        /**
         * Webhook encoding.
         * @member {events.Webhook.Encoding} encoding
         * @memberof events.Webhook
         * @instance
         */
        Webhook.prototype.encoding = 0;
         ...
         * @instance
         */
        Webhook.prototype.payload = null;
         ...
         * @static
         * @param {events.IWebhook=} [properties] Properties to set
         * @returns {events.Webhook} Webhook instance
         */
         ...
         * @memberof events.Webhook
         * @static
         * @param {events.IWebhook} message Webhook message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        Webhook.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
         ...
         * @returns {$protobuf.Writer} Writer
         */
        Webhook.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {events.Webhook} Webhook
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Webhook.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.events.Webhook();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 5:
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Webhook.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        Webhook.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.url != null && message.hasOwnProperty("url"))
         ...
         * @returns {events.Webhook} Webhook
         */
        Webhook.fromObject = function fromObject(object) {
            if (object instanceof $root.events.Webhook)
                return object;
            var message = new $root.events.Webhook();
            if (object.url != null)
            ...
            if (object.payload != null) {
                if (typeof object.payload !== "object")
                    throw TypeError(".events.Webhook.payload: object expected");
         ...
         * @memberof events.Webhook
         * @static
         * @param {events.Webhook} message Webhook
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        Webhook.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
                object.url = "";
                object.encoding = options.enums === String ? "JSON" : 0;
                object.payload = null;
            }
            if (message.url != null && message.hasOwnProperty("url"))
                object.url = message.url;
            if (message.encoding != null && message.hasOwnProperty("encoding"))
                object.encoding = options.enums === String ? $root.events.Webhook.Encoding[message.encoding] : message.encoding;
            if (message.payload != null && message.hasOwnProperty("payload"))
        ...
        /**
         * Encoding enum.
         * @name events.Webhook.Encoding
         * @enum {string}
         * @property {number} JSON=0 JSON value
         * @property {number} PROTO_BIN=1 PROTO_BIN value
         * @property {number} PROTO_64=2 PROTO_64 value
         */
        Webhook.Encoding = (function() {
            var valuesById = {}, values = Object.create(valuesById);
            values[valuesById[0] = "JSON"] = 0;
            values[valuesById[1] = "PROTO_BIN"] = 1;
            values[valuesById[2] = "PROTO_64"] = 2;
            return values;
        })();
